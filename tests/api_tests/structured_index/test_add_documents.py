...
class TestStructuredAddDocuments(MarqoTestCase):
    ...
    def test_add_docs_with_large_integers_and_floats(self):
        test_documents = [
            ...
            ({"long_field_1": 1002321422948}, False),  # large positive integer that can't be handled by int
            ({"long_field_1": -9232172132345}, False),  # large negative integer that can't be handled by int
            ...
            # large integer array that can't be handled by int
            ({"array_long_field_1": [10023214229483, -4923217213, 12390809]}, False),
